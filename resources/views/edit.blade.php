    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="row g-3" method="POST">
          {{csrf_field()}}
          <?php $arr = ["","","","","1d"=>"","2d"=>"","3d"=>""];
            $arr[$question->class] = "selected";
          ?>
          <div class="col-md-4">
            <select id="inputState" name="class" class="form-select">
              <option value="">الصف</option>
              <option value="1" {{$arr[1]}}>الأول الثانوي</option>
              <option value="2" {{$arr[2]}}>الثاني الثانوي</option>
              <option value="3" {{$arr[3]}}>الثالث الثانوي</option>
              <option value="1d" {{$arr['1d']}}>الأول الإعدادي</option>
              <option value="2d" {{$arr['2d']}}>الثاني الإعدادي</option>
              <option value="3d" {{$arr['3d']}}>الثالث الإعدادي</option>
            </select>
          </div>
          <?php $term = ["","",""];
          $term[$question->term] = "selected";
        ?>
          <div class="col-md-4">
            <select id="inputState" name="term" class="form-select">
              <option  value="" >الترم</option>
              <option value="1" {{$term[1]}}>الأول</option>
              <option value="2" {{$term[2]}}>الثاني</option>
            </select>
          </div>
          <?php $unit = ["","","","","","","","","","",""];
          $unit[$question->unit] = "selected";
        ?>
          <div class="col-md-4">
            <select id="inputState" name="unit" class="form-select">
              <option value="" >الباب</option>
              <option value="1" {{$unit[1]}}>1</option>
              <option value="2" {{$unit[2]}}>2</option>
              <option value="3" {{$unit[3]}}>3</option>
              <option value="4" {{$unit[4]}}>4</option>
              <option value="5" {{$unit[5]}}>5</option>
              <option value="6" {{$unit[6]}}>6</option>
              <option value="7" {{$unit[7]}}>7</option>
              <option value="8" {{$unit[8]}}>8</option>
              <option value="9" {{$unit[9]}}>9</option>
              <option value="10" {{$unit[10]}}>10</option>
            </select>
          </div>
          <?php $lesson = ["","","","","","","","","","",""];
          $lesson[$question->lesson] = "selected";
        ?>
          <div class="col-md-4">
            <select id="inputState" name="lesson" class="form-select">
              <option value="" selected>الدرس</option>
              <option value="1" {{$lesson[1]}}>1</option>
              <option value="2" {{$lesson[2]}}>2</option>
              <option value="3" {{$lesson[3]}}>3</option>
              <option value="4" {{$lesson[4]}}>4</option>
              <option value="5" {{$lesson[5]}}>5</option>
              <option value="6" {{$lesson[6]}}>6</option>
              <option value="7" {{$lesson[7]}}>7</option>
              <option value="8" {{$lesson[8]}}>8</option>
              <option value="9" {{$lesson[9]}}>9</option>
              <option value="10" {{$lesson[10]}}>10</option>
            </select>
          </div>
